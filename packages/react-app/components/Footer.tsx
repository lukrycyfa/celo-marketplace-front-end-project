...
const navigation = [
  ...
  export default function Footer() {
    return (
      <footer className="bg-gypsum mt-auto dark:bg-slate-800 dark:border-slate-500 border-black border-t">
        <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:order-1 dark:text-slate-400 md:mt-0">
            <p className="text-center text-base dark:text-slate-400">&copy; {new Date().getFullYear()} Developed with 🖤 by the Celo DevRel team.</p>
          </div>
        </div>
      </footer>
    )
